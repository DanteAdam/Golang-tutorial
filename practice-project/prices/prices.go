...
func (job *TaxIncludePricesJob) Process(doneChan chan bool, errorChan chan error) {
	err := job.LoadData()
...
func NewTaxIncludedPriceJob(iom iomanager.IOManager, taxRate float64) *TaxIncludePricesJob {
